;(function (define) {
    ...
    define(['backbone',
        ...
        function (Backbone, _, gettext, HeaderView, HeaderModel, TabbedView,
                  TopicsView, TopicModel, TopicCollection, TeamProfileView, TeamsView, TeamCollection, teamsTemplate) {
            ...
            var TeamTabView = Backbone.View.extend({
                initialize: function(options) {
                    ...
                    // TODO replace this with the actual "My Teams" view
                    this.teamView = new TeamProfileView({
                        courseId: this.topicsCollection.course_id
                    });
                ...
                getTopic: function (topicID) {
                    ...
                    if (topic) {
                        ...
                        var TopicModelWithUrl = TopicModel.extend({
                            url: function () { return self.topicUrl.replace('topic_id', this.id); }
                        });
