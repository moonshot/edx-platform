    ...
    def get_html(self):
        ...
        if self.edx_video_id and edxval_api:
            try:
                ...
                if not self.sub and not html5_transcript_cache and val_video_urls["youtube"]:
                    ...
                    try:
                        ...
                        item.sub = val_video_urls["youtube"]
                    ...
                    cache.set(cache_key, {'youtube_hit': True, 'found': found_transcript})
